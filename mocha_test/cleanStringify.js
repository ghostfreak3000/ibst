...
describe("cleanStringify",function(){
    it("can handle values of arbitrary data",function(){
    var grades = new ibst([
        ...
        var cleanString = clean.stringify(grades);
        expect((cleanString.match(/value/g) || []).length).to.equal(0);
    })    
})